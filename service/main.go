...
func run() error {
	...
	curveKeyPair, err = nkeys.FromSeed([]byte("SXANPB47UINQR7EXT3BRP26A4LY2CMCDLTY2KX6BU3EGK2VZYREJ4IJRCE"))
	if err != nil {
	...
	nc, err := nats.Connect("nats://auth:auth@localhost")
	if err != nil {
		return err
	}
	defer nc.Drain()
